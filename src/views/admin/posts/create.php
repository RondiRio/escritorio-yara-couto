...
<div class="page-header">
    ...
    <p>Adicione um novo artigo ao blog</p>
</div>

<!-- Form Container -->
<div class="form-container">
    <form action="<?= base_url('admin/posts/criar') ?>" method="POST" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <div class="form-group">
            ...
            <input type="text" 
                   ...
                   required
                   autofocus>
            <div class="form-help">O slug será gerado automaticamente a partir do título</div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <div class="form-help">Posts publicados ficam visíveis imediatamente</div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-help">Aparecerá nas listagens e compartilhamentos. Máximo 200 caracteres.</div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-help">Selecione as tags relacionadas ao conteúdo</div>
        </div>
